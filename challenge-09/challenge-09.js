(function() {
  ...
  */
  console.log('O resultado da soma é: ' + sum(function(valueOne, valueTwo) { 
  ...
  */
  ...
  var multiplication = calculator(4, 7);
  var division = calculator(10, 2);
  var mod = calculator(13, 6);
  ...
  chamada.
  */
  console.log('O resultado da subtração é: ' + subtraction(function(valueOne, valueTwo) {
    return valueOne - valueTwo;
  }));
  // O resultado da subtração é: 2
  
  console.log('O resultado da multiplicação é: ' + multiplication(function(valueOne, valueTwo) {
    return valueOne * valueTwo;
  }));
  // O resultado da multiplicação é: 28
  
  console.log('O resultado da divisão é: ' + division(function(valueOne, valueTwo) {
    return valueOne / valueTwo;
  }));
  // O resultado da divisão é: 5
  
  console.log('O resultado do resto da divisão é: ' + mod(function(valueOne, valueTwo) {
    return valueOne % valueTwo;
  }));
  // O resultado do resto da divisão é: 1
})();  
